...
//            startService(new Intent(this, WidgetUpdateService.class));
    ...
    private void updateNotificationState() {
        ...
        if (prefs.getBoolean("notification", true)) {
            int goal = prefs.getInt("goal", 1000000);
            Database db = Database.getInstance(this);
            ...
            if (steps > 0) {
                ...
                notificationBuilder.setProgress(goal, today_offset + steps, false).setContentText(today_offset + steps >= goal ? getString(R.string.goal_reached_notification, NumberFormat.getInstance(Locale.getDefault())
